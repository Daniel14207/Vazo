...
export const teamsByLeague: Record<string, TeamStats[]> = {
  ...
  'afr': [
    generateTeamStats('afr_1', 'Senegal', 'https://upload.wikimedia.org/wikipedia/en/3/3f/Senegal_national_football_team_logo.svg'),
    generateTeamStats('afr_2', 'Egypt', 'https://upload.wikimedia.org/wikipedia/en/1/1c/Egypt_national_football_team_logo.svg'),
    generateTeamStats('afr_3', 'Morocco', 'https://upload.wikimedia.org/wikipedia/en/7/7e/Royal_Moroccan_Football_Federation_logo.svg'),
    generateTeamStats('afr_4', 'Nigeria', 'https://upload.wikimedia.org/wikipedia/en/1/16/Nigeria_national_football_team_logo.svg'),
    generateTeamStats('afr_5', 'Cameroon', 'https://upload.wikimedia.org/wikipedia/en/4/45/F%C3%A9d%C3%A9ration_Camerounaise_de_Football_logo.svg'),
    generateTeamStats('afr_6', 'Algeria', 'https://upload.wikimedia.org/wikipedia/en/6/6a/Algerian_Football_Federation_logo.svg'),
    generateTeamStats('afr_7', 'Ivory Coast', 'https://upload.wikimedia.org/wikipedia/en/7/76/Ivory_Coast_national_football_team_logo.svg'),
    generateTeamStats('afr_8', 'Ghana', 'https://upload.wikimedia.org/wikipedia/en/2/26/Ghana_Football_Association_logo.svg'),
  ],
  'ita': [
